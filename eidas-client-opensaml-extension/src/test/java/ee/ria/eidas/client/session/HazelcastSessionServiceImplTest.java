...
public class HazelcastSessionServiceImplTest {
    ...
    public void getRequestSession_returnsSession_whenSavedBeforehand() {
        ...
        UnencodedRequestSession originalRequestSession = new UnencodedRequestSession(requestID, Instant.now(), AssuranceLevel.LOW, AuthInitiationService.DEFAULT_REQUESTED_ATTRIBUTE_SET, "CA");
