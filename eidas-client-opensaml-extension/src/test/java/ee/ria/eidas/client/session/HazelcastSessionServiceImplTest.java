...
public class HazelcastSessionServiceImplTest {
    ...
    public void getRequestSession_returnsSession_whenSavedBeforehand() {
        ...
        UnencodedRequestSession originalRequestSession = new UnencodedRequestSession(requestID, new DateTime(), AssuranceLevel.LOW, AuthInitiationService.DEFAULT_REQUESTED_ATTRIBUTE_SET, "CA");
