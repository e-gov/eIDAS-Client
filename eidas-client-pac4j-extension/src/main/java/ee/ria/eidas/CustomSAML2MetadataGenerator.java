...
public class CustomSAML2MetadataGenerator implements org.pac4j.saml.metadata.SAMLMetadataGenerator {

    protected final static Logger logger = LoggerFactory.getLogger(CustomSAML2MetadataGenerator.class);
    ...
    public CustomSAML2MetadataGenerator(final String binding) {
