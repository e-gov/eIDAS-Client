...
public class CustomSAML2ServiceProviderMetadataResolver implements SAML2MetadataResolver {
    protected final static Logger logger = LoggerFactory.getLogger(CustomSAML2ServiceProviderMetadataResolver.class);
    ...
    public CustomSAML2ServiceProviderMetadataResolver(final SAML2ClientConfiguration configuration,
    ...
    public final MetadataResolver resolve() {
        ...
        try {
            final CustomSAML2MetadataGenerator metadataGenerator = new CustomSAML2MetadataGenerator(binding);
